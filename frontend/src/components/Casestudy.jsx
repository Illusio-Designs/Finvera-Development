...
import gallery1 from "../../src/assets/Motor & Vehicle Insurance Claim Settlement.webp";
import gallery2 from "../../src/assets/Factory Act License Renewal.webp";
import gallery3 from "../../src/assets/Contract Labour Act Registration.webp";
import gallery4 from "../../src/assets/Fire Insurance Claim.webp";
import gallery5 from "../../src/assets/ESIC & PF Registration Drive.webp";
...
const Casestudy = memo(() => {
  const cases = useMemo(() => [
    ...
    { src: gallery4, tag: 'Insurance',   title: 'Fire Insurance Claim',        desc: '₹15L claim settled with complete documentation.' },
