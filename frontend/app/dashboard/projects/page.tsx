  ...
  return (
    <ResourceManager
      ...
      fields={[
        ...
        { name: "challenge", label: "The challenge", type: "richtext", placeholder: "What problem were we solving?" },
        { name: "approach", label: "Our approach", type: "richtext", placeholder: "How we solved it" },
