...
export default function AdminLogos() {
  return <ResourceManager resource="logos" backHref="/dashboard/content" backLabel="Site content" title="Trusted-by logos" subtitle="Real client / partner logos in the 'Trusted by' marquee on the home page. Upload a logo image (SVG or transparent PNG works best)."
